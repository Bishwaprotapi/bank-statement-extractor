...
def process_ebl_bank_statement_service(pdf_path):
    """
    Service layer function to process ebl bank statement files
    ...
    try:
        ...
        raise Exception(f"Service error in EBL bank statement processing: {str(e)}")
