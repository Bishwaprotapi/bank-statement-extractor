...
def process_ucb_bank_statement_service(pdf_path):
    """
    Service layer function to process UCB bank statement files
    ...
    try:
        ...
        raise Exception(f"Service error in UCB bank statement processing: {str(e)}")
