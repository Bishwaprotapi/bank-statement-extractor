...
def process_bank_statement_service(pdf_path):
    """
    Service layer function to process jamuna bank statement files
    ...
    try:
        ...
        raise Exception(f"Service error in jamuna bank statement processing: {str(e)}")
