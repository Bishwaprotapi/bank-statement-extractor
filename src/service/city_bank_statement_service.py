...
def process_city_bank_statement_service(pdf_path):
    """
    Service layer function to process city bank statement files
    ...
    try:
        ...
        raise Exception(f"Service error in city bank statement processing: {str(e)}")
