...
def process_ncc_bank_statement_service(pdf_path):
    """
    Service layer function to process NCC bank statement files
    ...
    try:
        ...
        raise Exception(f"Service error in NCC bank statement processing: {str(e)}")
