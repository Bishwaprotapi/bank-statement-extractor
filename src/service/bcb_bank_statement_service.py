...
def process_bcb_bank_statement_service(pdf_path):
    """
    Service layer function to process BCB bank statement files
    ...
    try:
        ...
        raise Exception(f"Service error in BCB bank statement processing: {str(e)}")
