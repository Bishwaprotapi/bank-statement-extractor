...
def process_midland_bank_statement_service(pdf_path):
    """
    Service layer function to process Midland bank statement files
    ...
    try:
        ...
        raise Exception(f"Service error in Midland bank statement processing: {str(e)}")
