...
def process_bank_asia_statement_service(pdf_path):
    """
    Service layer function to process bank asia statement files
    ...
    try:
        ...
        raise Exception(f"Service error in Bank Asia statement processing: {str(e)}")
