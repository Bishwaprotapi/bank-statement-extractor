...
def process_mtbl_bank_statement_service(pdf_path):
    """
    Service layer function to process Mutual Trust Bank bank statement files
    ...
    try:
        ...
        raise Exception(f"Service error in Mutual Trust Bank bank statement processing: {str(e)}")
